...
export class CategoryRuleController {
  ...
  async createRule(
    ...
    try {
      ...
      return ResponseHelper.success(reply, 201, 'Category rule created successfully', rule)
    } catch (error) {
  ...
  async updateRule(
    ...
    try {
      ...
      return ResponseHelper.success(reply, 200, 'Category rule updated successfully', rule)
    } catch (error) {
      return ResponseHelper.error(reply, error)
    }
  }
  ...
  async deleteRule(
    ...
    try {
      ...
      const command: DeleteCategoryRuleCommand = { ruleId }
      await this.deleteRuleHandler.execute(command)

      return ResponseHelper.success(reply, 200, 'Category rule deleted successfully')
    } catch (error) {
      return ResponseHelper.error(reply, error)
    }
  }
  ...
  async activateRule(
    ...
    try {
      ...
      const command: ActivateCategoryRuleCommand = { ruleId }
      const rule = await this.activateRuleHandler.execute(command)

      return ResponseHelper.success(reply, 200, 'Category rule activated successfully', rule)
    } catch (error) {
      return ResponseHelper.error(reply, error)
    }
  }
  ...
  async deactivateRule(
    ...
    try {
      ...
      const command: DeactivateCategoryRuleCommand = { ruleId }
      const rule = await this.deactivateRuleHandler.execute(command)

      return ResponseHelper.success(reply, 200, 'Category rule deactivated successfully', rule)
    } catch (error) {
      return ResponseHelper.error(reply, error)
    }
  }
  ...
  async getRuleById(
    ...
    try {
      ...
      return ResponseHelper.success(reply, 200, 'Category rule retrieved successfully', rule)
    } catch (error) {
      return ResponseHelper.error(reply, error)
    }
  }
  ...
  async listRules(
    ...
    try {
      ...
      if (activeOnly === 'true') {
        ...
        const rules = await this.getActiveRulesByWorkspaceHandler.execute(query)
        return ResponseHelper.success(reply, 200, 'Active category rules retrieved successfully', rules)
      } else {
        const query: GetRulesByWorkspaceQuery = { workspaceId }
        const rules = await this.getRulesByWorkspaceHandler.execute(query)
        return ResponseHelper.success(reply, 200, 'Category rules retrieved successfully', rules)
      }
    } catch (error) {
      return ResponseHelper.error(reply, error)
    }
