...
export class GetInvitationByTokenHandler {
  ...
  async handle(query: GetInvitationByTokenQuery): Promise<WorkspaceInvitation | null> {
...
export class GetWorkspaceInvitationsHandler {
  ...
  async handle(query: GetWorkspaceInvitationsQuery): Promise<WorkspaceInvitation[]> {
    return await this.invitationService.getWorkspaceInvitations(query.workspaceId)
  }
}
...
export class GetPendingInvitationsHandler {
  ...
  async handle(query: GetPendingInvitationsQuery): Promise<WorkspaceInvitation[]> {
    return await this.invitationService.getPendingInvitations(query.workspaceId)
  }
}
