...
export class TagService {
  ...
  async deleteTag(tagId: string, workspaceId: string): Promise<void> {
    ...
    const exists = await this.tagDefinitionRepository.exists(tagIdObj, workspaceId)
  ...
  async getTag(tagId: string, workspaceId: string): Promise<ReceiptTagDefinition | null> {
  ...
  async getTagsByWorkspace(workspaceId: string): Promise<ReceiptTagDefinition[]> {
    return await this.tagDefinitionRepository.findByWorkspace(workspaceId)
  }

  async getTagByName(name: string, workspaceId: string): Promise<ReceiptTagDefinition | null> {
