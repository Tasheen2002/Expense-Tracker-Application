...
export class ReceiptMetadata {
  ...
  updateFinancialAmounts(data: {
    ...
    if (data.subtotal !== undefined) {
      this.props.subtotal = data.subtotal ? new Decimal(data.subtotal) : undefined
    }
    if (data.taxAmount !== undefined) {
      this.props.taxAmount = data.taxAmount ? new Decimal(data.taxAmount) : undefined
    }
    if (data.tipAmount !== undefined) {
      this.props.tipAmount = data.tipAmount ? new Decimal(data.tipAmount) : undefined
    }
    if (data.totalAmount !== undefined) {
      this.props.totalAmount = data.totalAmount ? new Decimal(data.totalAmount) : undefined
    }
  ...
  updateNotes(notes: string): void {
    this.props.notes = notes || undefined
    this.props.updatedAt = new Date()
  }
