...
export interface IReceiptMetadataRepository {
  ...
  findByInvoiceNumber(invoiceNumber: string, workspaceId: string): Promise<ReceiptMetadata[]>
  findByMerchantName(merchantName: string, workspaceId: string): Promise<ReceiptMetadata[]>
