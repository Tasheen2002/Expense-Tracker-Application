...
import { registerCategorizationRulesRoutes } from '../../../modules/categorization-rules/infrastructure/http/routes/index';
...
export default fp(
  async (fastify) => {
    ...
    await registerAuditComplianceRoutes(
      fastify,
      { auditLogController: auditComplianceServices.auditLogController },
